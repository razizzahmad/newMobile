...
class karyawan_22312019Controller extends GetxController {
  ...
  Future<QuerySnapshot<Object?>> GetData() async {
    CollectionReference karyawan_22312019 = firestore.collection('karyawan_22312019');

    return karyawan_22312019.get();
  }

  Stream<QuerySnapshot<Object?>> streamData() {
    CollectionReference karyawan_22312019 = firestore.collection('karyawan_22312019');
    return karyawan_22312019.snapshots();
  }
  ...
  Future<DocumentSnapshot<Object?>> GetDataById(String id) async {
    DocumentReference docRef = firestore.collection("karyawan_22312019").doc(id);

    return docRef.get();
  }

  void Update(String nama_karyawan, String no_karyawan, String jabatan_karyawan, String id) async {
    DocumentReference karyawan_22312019ById = firestore.collection("karyawan_22312019").doc(id);
    ...
    try {
      ...
      // Perform update
      await karyawan_22312019ById.update({
        "nama_karyawan": nama_karyawan,
        "no_karyawan": no_karyawan,
        "jabatan_karyawan": jabatan_karyawan,
      });
